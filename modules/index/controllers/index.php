...
class Controller extends \Gcms\Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($login) {
            ...
            $user_icon = is_file(ROOT_PATH.DATA_FOLDER.'members/'.$login['id'].'.jpg') ? WEB_URL.DATA_FOLDER.'members/'.$login['id'].'.jpg' : WEB_URL.'skin/img/noicon.jpg';
        } else {
            $loginname = '<a href="index.php?module=welcome&amp;action=login">{LNG_Please login}</a>';
            $user_icon = WEB_URL.'skin/img/noicon.jpg';
        }
        // เนื้อหา
